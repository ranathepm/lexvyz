...
const integrations = [
  ...
  { name: "Google Business", category: "SEO" },
  { name: "Zapier", category: "Auto" },
  { name: "Avvo", category: "Directories" },
  { name: "Justia", category: "Directories" },
  { name: "FindLaw", category: "Directories" },
  { name: "LawPay", category: "Payments" },
];
