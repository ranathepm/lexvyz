...
const steps = [
  ...
  },
  {
    ...
    description: "We deploy your AI receptionist, intake automation, chatbot, CRM workflows, and local SEO pages — tuned to your practice areas and your market.",
    code: `await lexvyz.deploy({
  receptionist: '24/7 voice agent',
  intake: 'auto-qualify + book',
  crm: 'GoHighLevel pipeline',
  seo: 'practice-area x city pages'
})`,
  },
  {
    number: "03",
    title: "Grow",
    subtitle: "& optimize",
    description: "Weekly check-ins, monthly deltas, quarterly strategy. We report the numbers that matter: calls answered, leads captured, consults booked, cases won.",
    code: `lexvyz.dashboard({
  metrics: ['answered', 'booked', 'retained'],
  cadence: 'weekly review',
})
// +40% consults booked this month`,
  },
];
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <div className={`mt-8 inline-flex items-center gap-3 transition-all duration-1000 delay-200 ${
              ...
              <span className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-white/25 text-white text-sm font-mono gradient-bg-soft">
