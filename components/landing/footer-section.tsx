...
const footerLinks = {
  Services: [
    ...
    { name: "AI Client Intake", href: "#features" },
    { name: "Websites & Chatbots", href: "#features" },
    { name: "CRM & Follow-Up", href: "#features" },
    { name: "Local SEO", href: "#features" },
  ],
  Company: [
    { name: "Our Process", href: "#how-it-works" },
    { name: "Target Markets", href: "#infra" },
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="py-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-white/30">
            &copy; 2026 LEXVYZ. All rights reserved.
          </p>
