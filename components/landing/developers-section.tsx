...
const features = [
  { 
    ...
    description: "24/7 voice AI that never puts a client on hold."
  },
  { 
    title: "Intake that qualifies", 
    description: "Conflict checks, case details, and booking in one call."
  },
  { 
    title: "Follow-up on autopilot", 
    description: "SMS + email sequences until the consult is on the calendar."
  },
  { 
    title: "SEO that compounds", 
    description: "Practice-area pages that win the Google 3-pack."
  },
];
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <h2 className="text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9]">
            From first ring
            <br />
            <span className="text-muted-foreground">to signed retainer.</span>
          </h2>
        </div>
