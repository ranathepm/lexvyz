...
const regions = [
  { name: "Tulsa, OK", nodes: 692, status: "launch market" },
  { name: "Boise, ID", nodes: 132, status: "expansion" },
  { name: "Knoxville, TN", nodes: 350, status: "expansion" },
  { name: "Huntsville, AL", nodes: 221, status: "volume play" },
];
          ...
          <div className="grid lg:grid-cols-[auto_1fr] gap-8 lg:gap-16 items-stretch">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className={`mt-8 text-xl text-muted-foreground leading-relaxed max-w-lg transition-all duration-1000 delay-100 ${
                ...
                We target underserved U.S. metros where firms are losing cases to missed calls — 
                starting with Tulsa, where 42% of attorneys have no website at all.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className={`lg:col-span-2 relative p-8 lg:p-12 border border-foreground/10 bg-foreground/[0.02] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              <div className="flex items-baseline gap-2 mb-4">
                <span className="text-8xl lg:text-[10rem] font-display leading-none">42%</span>
                <span className="text-2xl text-muted-foreground">no website</span>
              </div>
              <p className="text-muted-foreground max-w-md">
                Tulsa attorneys without any digital intake. 80.5% solo — every call is the owner. Zero AI agency competition in the market.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6">
            <div className={`p-8 border border-foreground/10 bg-foreground/[0.02] transition-all duration-700 delay-100 ${
              ...
              <span className="text-5xl lg:text-6xl font-display">$380B</span>
              <span className="block text-sm text-muted-foreground mt-2">US legal market</span>
            </div>
            ...
            <div className={`p-8 border border-foreground/10 bg-foreground/[0.02] transition-all duration-700 delay-200 ${
              ...
              <span className="block text-sm text-muted-foreground mt-2">of what you&apos;re losing</span>
            </div>
          </div>
        </div>
            ...
            >
              <div className="flex items-center gap-2 mb-3">
                <span className={`w-2 h-2 rounded-full transition-colors ${
                  activeRegion === index ? "bg-[#ff4d6d]" : "bg-foreground/20"
                }`} />
              ...
              <span className="text-sm text-muted-foreground">{region.nodes} attorneys</span>
            </div>
          ))}
        </div>
      </div>
